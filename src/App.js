      ...
      <section id="landing-page">
        ...
        <header className="header">
          ...
          <div className="social__list">
             <a href="https://www.linkedin.com/in/shabnam-khan-269384234/" target="_blank" className="social__link click">
               <LinkedInIcon/>
             </a>
             <a href="https://github.com/S-J-K123" target="_blank" className="social__link click">
               <GitHubIcon/>
             </a>
